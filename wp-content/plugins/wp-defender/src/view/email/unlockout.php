...
<p style="color: #1A1A1A; font-family: Roboto, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 24px; margin: 0; padding: 0 0 24px; text-align: left;">
	<?php esc_html_e( 'We have received a request to unblock an IP address that appears to be locked out of your site.', 'wpdef' ); ?>
</p>
<p style="color: #1A1A1A; font-family: Roboto, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 24px; margin: 0; padding: 0 0 24px; text-align: left;">
	<?php
	/* translators: %s: Generated time. */
	printf( __( 'This request was generated on %s.', 'wpdef' ), esc_html( $generated_time ) ); ?>
</p>
<p style="color: #1A1A1A; font-family: Roboto, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 24px; margin: 0; padding: 0 0 24px; text-align: left;">
	<?php
...
<p style="color: #1A1A1A; font-family: Roboto, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 24px; margin: 0; padding: 0 0 24px; text-align: left;">
	<?php esc_html_e( 'Please note that this link is only valid for 30 minutes from the time of generation.', 'wpdef' ); ?>
</p>
<p style="font-family: Roboto, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 24px; margin: 0; padding: 0 0 24px; text-align: center;">
	<?php
	/* translators: %s: Unlocked link. */
	printf( '<a class="button view-full" href="%s">' . __( 'Unlock me', 'wpdef' ) . '</a>', $escaped_link ); ?>
</p>