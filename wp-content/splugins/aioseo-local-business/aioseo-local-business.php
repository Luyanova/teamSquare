...
function aioseo_local_business_translations() {
	$translations = new AIOSEOTranslations(
		...
		'https://packages.translationspress.com/aioseo/aioseo-local-business/packages.json'
	);
	$translations->init();
...
new AIOSEOExtend( 'AIOSEO - Local Business', 'aioseo_local_business_load', AIOSEO_LOCAL_BUSINESS_FILE, '4.1.6' );
...
function aioseo_local_business_load() {
	...
	$extend = new AIOSEOExtend( 'AIOSEO - Local Business', '', AIOSEO_LOCAL_BUSINESS_FILE, '4.1.6', $levels );
	if ( ! aioseo()->pro ) {
