	...
	public function render_dashboard() {
		...
		if ( ! $is_logged_in ) {
			...
			$this->render_with_sui_wrapper(
				'sui/dashboard',
				compact( 'data', 'member', 'urls', 'type', 'licensed_projects', 'projects_nr', 'active_projects', 'free_plugins', 'update_plugins', 'staff_login', 'whitelabel_settings', 'analytics_enabled', 'analytics_allowed', 'whitelabel_allowed', 'total_visits', 'membership_data', 'tickets_hidden' )
			);
		}
	}
