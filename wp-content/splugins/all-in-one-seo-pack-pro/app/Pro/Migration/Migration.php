...
class Migration extends CommonMigration\Migration {
	...
	public function doMigration() {
		...
		aioseo()->cache->update( 'v3_migration_in_progress_terms', time(), WEEK_IN_SECONDS );
	...
	public function isMigrationRunning() {
		return parent::isMigrationRunning() || aioseo()->cache->get( 'v3_migration_in_progress_terms' );
	}
}