...
class PrixMetaBox
{
    const META_KEY = 'ts24_prix';
    const NONCE_KEY = 'ts24_prix_nonce';
    ...
    {
        $post_types = ['activiteTeamSquare', 'packTeamSquare'];
        foreach ($post_types as $post_type) {
            add_meta_box(self::META_KEY, 'Prix (prix barré)', [self::class, 'render'], $post_type, 'side');
        }
    }
    ...
    public static function render($post)
    {
        ...
        ?>
        <label for="<?php echo self::META_KEY; ?>">Prix (prix barré) :</label>
