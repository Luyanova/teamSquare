...
class DomicileMetaBox {
    const META_KEY = 'ts24_domicile';
    const NONCE_KEY = 'ts24_domicile_nonce';
    ...
    public static function add() {
        add_meta_box(self::META_KEY, 'Domicile', [self::class, 'render'], 'activiteTeamSquare', 'side');
    }
    ...
    public static function render($post) {
        ...
        <label for="ts24Domicile">Cette activité peut se faire à domicile ?</label>
        <?php
    }
