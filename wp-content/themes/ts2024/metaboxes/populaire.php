...
class PopulaireMetaBox {
    const META_KEY = 'ts24_populaire';
    const NONCE_KEY = 'ts24_populaire_nonce';
    ...
    public static function add() {
        ...
        foreach ($post_types as $post_type) {
            add_meta_box(self::META_KEY, 'Populaire', [self::class, 'render'], $post_type, 'side');
        }
    }
    ...
    public static function render($post) {
        ...
        <label for="ts24Populaire">Article dans le caroussel populaire ?</label>
        <?php
    }
