...
class NavGroupeMetaBox {
    const META_KEY = 'ts24_nav_groupe';
    const NONCE_KEY = 'ts24_nav_groupe_nonce';
    ...
    public static function add() {
        add_meta_box(self::META_KEY, 'Navigation Activité', [self::class, 'render'], 'post', 'side');
    }
    ...
    public static function render($post) {
        ...
        <label for="ts24NavGroupe">Cet article se trouve t'il dans le menu groupe ?</label>
        <?php
    }
