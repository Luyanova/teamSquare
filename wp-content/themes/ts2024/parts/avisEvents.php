<div class="avisContainer">
    ...
    <div class="avisTop">
        <h2>Ils ont célébré avec nous</h2>
        <div class="avisTop">
    ...
    if ($parent_category_id) {
        ...
        $child_category = get_term_by('slug', 'avis-events', 'category');
    ...
    if ($child_category_id) {
        ...
        if ($query->have_posts()) :
            while ($query->have_posts()) : $query->the_post(); ?>
                <div class="avisFlex">
                    <?php echo wp_get_attachment_image(15968, 'medium', false, ['alt' => 'Étoiles Events']); ?>
